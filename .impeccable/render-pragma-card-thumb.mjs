...
const html = fs.readFileSync(path.join(ROOT, ".impeccable/pragma-card-thumb.html"), "utf8");
const tmpPng = path.join(ROOT, ".impeccable/pragma-card-thumb-tmp.png");
const outWebp = path.join(ROOT, "public/case-thumbs/pragma-card.webp");
